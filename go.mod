module github.com/liggitt/audit2rbac
...
replace (
	...
	k8s.io/cluster-bootstrap => k8s.io/cluster-bootstrap v0.23.16
	...
	k8s.io/kube-scheduler => k8s.io/kube-scheduler v0.23.16
	k8s.io/kubectl => k8s.io/kubectl v0.23.16
	k8s.io/kubelet => k8s.io/kubelet v0.23.16
	...
	k8s.io/node-api => k8s.io/node-api v0.23.16
	k8s.io/pod-security-admission => k8s.io/pod-security-admission v0.23.16
	k8s.io/sample-apiserver => k8s.io/sample-apiserver v0.23.16
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.23.16
	k8s.io/sample-controller => k8s.io/sample-controller v0.23.16
)
